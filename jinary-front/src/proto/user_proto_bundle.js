...
export function encodeUserList(message) {
  let bb = popByteBuffer();
  _encodeUserList(message, bb);
  return toUint8Array(bb);
}

function _encodeUserList(message, bb) {
...
export function decodeUserList(binary) {
  return _decodeUserList(wrapByteBuffer(binary));
}

function _decodeUserList(bb) {
  let message = {};
